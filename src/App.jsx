...
1. flow: DEMAND (sector benefits), PRESSURE (sector faces headwinds), VOLATILE (mixed), WATCH (monitor).
1. reason: ONE sentence — the specific macro mechanism affecting this sector.
1. tickers: 4-5 most relevant US-listed tickers for this sector in this context.
   SCHEMA: {“sectors”:[{“name”:“string”,“flow”:“DEMAND|PRESSURE|VOLATILE|WATCH”,“reason”:“string”,“tickers”:[“string”]}]}`;   const msg = `Current time: ${now}. Macro context: “${macroContext.macro_theme}”. ${macroContext.geopolitical ? “Geopolitical: “ + macroContext.geopolitical + “.” : “”} ${macroContext.headline ? “Current driver: “ + macroContext.headline : “”} Which stock sectors are directly affected? For each sector, list 4-5 relevant US tickers.`;
...
const now = new Date().toLocaleString(“en-GB”, { weekday:“long”, year:“numeric”, month:“long”, day:“numeric”, hour:“2-digit”, minute:“2-digit”, timeZone:“America/New_York” });
const sysLines = [
“You are a professional equity macro analyst writing an end-of-day debrief for a stock.”,
...
1. session_summary must be ONE short sentence max — like a trading journal entry. Under 120 characters.
