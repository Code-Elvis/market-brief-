...
if (path === “/app”) return <AppShell navigate={navigate} />;
...
```
  ...
  <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 32px 80px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
    {[
      ...
      { icon: "⚡", title: "Scalper Mode", desc: "10-second risk check before you enter. GREEN / YELLOW / RED with breaking news and imminent events." },
      { icon: "⊕", title: "Options Flow", desc: "Dealer positioning, gamma levels, max pain strikes. Know where the market is pinned." },
...
{view === “sign-in”
? <SignIn forceRedirectUrl=”/app” fallbackRedirectUrl=”/app” routing=“hash” appearance={{ variables: { colorBackground: “#0d1117”, colorText: “#e0e0e0”, colorPrimary: “#00d4ff”, colorInputBackground: “#161b22”, colorInputText: “#e0e0e0” } }} />
: <SignUp forceRedirectUrl=”/app” fallbackRedirectUrl=”/app” routing=“hash” appearance={{ variables: { colorBackground: “#0d1117”, colorText: “#e0e0e0”, colorPrimary: “#00d4ff”, colorInputBackground: “#161b22”, colorInputText: “#e0e0e0” } }} />
}
</div>
...
<div style={{ flex: 1 }}><div style={{ display: “flex”, gap: 8, alignItems: “center”, marginBottom: 4 }}><span style={{ fontSize: 9, fontWeight: 800, letterSpacing: 1.2, color: meta.color, border: “1px solid “ + meta.color + “44”, padding: “2px 7px”, borderRadius: 3 }}>{meta.label}</span></div><div style={{ fontSize: 15, fontWeight: 800, color: “#f0f0f0”, fontFamily: “monospace” }}>{level.label}</div></div>
...
if (!isPro) return (<div style={{ textAlign: “center”, padding: “60px 20px” }}><div style={{ fontSize: 32, marginBottom: 18, opacity: 0.2 }}>⊕</div><div style={{ fontSize: 15, fontWeight: 700, color: “#e0e0e0”, marginBottom: 10 }}>Options Flow</div><div style={{ fontSize: 13, color: “#444”, lineHeight: 1.7, maxWidth: 300, margin: “0 auto 24px” }}>Dealer positioning, key gamma levels, and options flow intelligence. Pro feature.</div><button onClick={onUpgrade} style={{ padding: “11px 24px”, borderRadius: 8, cursor: “pointer”, background: “rgba(0,212,255,.1)”, color: “#00d4ff”, border: “1px solid rgba(0,212,255,.25)”, fontSize: 12, fontWeight: 700, fontFamily: “inherit” }}>UPGRADE TO PRO</button></div>);
...
if (data && data.coming_soon) return (<div style={{ textAlign: “center”, padding: “60px 20px” }}><div style={{ fontSize: 32, marginBottom: 18, opacity: 0.15 }}>◎</div><div style={{ fontSize: 15, fontWeight: 700, color: “#e0e0e0”, marginBottom: 10 }}>Options Flow</div><div style={{ fontSize: 13, color: “#444”, lineHeight: 1.7, maxWidth: 320, margin: “0 auto 20px” }}>Real-time dealer positioning launching soon.</div><div style={{ display: “inline-flex”, gap: 6, alignItems: “center”, padding: “6px 14px”, borderRadius: 20, border: “1px solid rgba(0,212,255,.15)”, background: “rgba(0,212,255,.04)” }}><div style={{ width: 6, height: 6, borderRadius: “50%”, background: “#00d4ff”, opacity: 0.5 }} /><span style={{ fontSize: 11, color: “#00d4ff”, opacity: 0.5, letterSpacing: 1, fontWeight: 700 }}>COMING SOON</span></div></div>);
if (error) return <div style={{ color: “#ff4757”, padding: “16px 0”, fontSize: 13 }}>{error}</div>;
if (!data) return (<div style={{ textAlign: “center”, padding: “40px 20px” }}><div style={{ fontSize: 13, color: “#555”, marginBottom: 16 }}>Options flow for <span style={{ color: inst.color }}>{inst.label}</span> via {inst.optionsTicker}</div><button onClick={onFetch} style={{ padding: “11px 24px”, borderRadius: 8, cursor: “pointer”, background: “rgba(0,212,255,.1)”, color: “#00d4ff”, border: “1px solid rgba(0,212,255,.25)”, fontSize: 12, fontWeight: 700, fontFamily: “inherit” }}>LOAD OPTIONS FLOW</button></div>);
return (
<div>
